  ...
  ko: [
    {
      ...
      languages: ['한국어', '영어'],
      bio: [
        '김성민 변호사는 약 20년간 주택 구입자, 매도인, 투자자, 사업주를 대리하며 부동산 거래와 그에 수반되는 법률 문제를 다뤄 왔습니다. 올바니 로스쿨(Albany Law School)을 졸업하고 2006년 뉴욕주 변호사 자격을 취득했으며, "고객은 모든 서류를 설명해 주고, 모든 문제를 미리 짚어 주며, 모든 전화에 회신하는 변호사를 만날 자격이 있다"는 신념 위에 사무소를 운영해 왔습니다.',
    ...
    },
    {
      ...
      title: '변호사',
      languages: ['한국어', '영어'],
      bio: ['김동성 변호사는 사무소의 부동산 업무 전반을 담당하고 있습니다.'],
    },
  ],
};
